...
def process(path):
    # load the query image and describe it
        ...
        avgval = ij /len (tr)
        for ntr in nr:
            ni=image_similarity_vectors_via_numpy(file ,ntr )
            nj+=ni
            print (ni)
        avgvaln = nj /len (ntr)
        print ('Avg value')
        ...
        if avgval > avgvaln:
            ...
            if avgval >.75:
                #print 'Affected Area '
                #print lev
                #print 'Tumour Classfied Score  '
                #print avgval
            
                #print ' Highlevel Tumour '
                resultText='Highlevel Tumour'
                tm.showinfo('Predicted Result',resultText)
                img=cv2.imread(file)
                #print file
                #cv2.imwrite('Result/High/'+file, img)
                #cv2.imwrite( 'Result/High/Dataset/'+file, img)
                print('Life Time of the patient:')
                aa=avgval*10
                print (round(10-aa))
            elif avgval >.70:
                #print 'Affected Area '
               ...
               # print 'Tumour Classfied Score  '
               # print avgval
                #print ' Intermediate Tumour '
                resultText='Intermediate Tumour'
                tm.showinfo('Predicted Result',resultText)
                img = cv2.imread(file)
               # print file
                # cv2.imwrite('Result/High/'+file, img)
                #cv2.imwrite('Result/Intermediate/Dataset/' + file, img)
                print('Life Time of the patient:')
                aa=avgval*10
                print (round(10-aa))
            elif avgval >.60:
...
##                print avgval
##                print 'begining '
                resultText='Begining Tumour'
                tm.showinfo('Predicted Result',resultText)
                img = cv2.imread(file)
                #print file
                # cv2.imwrite('Result/High/'+file, img)
                #cv2.imwrite('Result/Begining/Dataset/' + file, img)
                print('Life Time of the patient:')
                aa=avgval*10
                print (round(10-aa))
            else:
               # print'Normal'
                ...
                #print file
                # cv2.imwrite('Result/High/'+file, img)
                #cv2.imwrite('Result/normal/Dataset/' + file, img)
